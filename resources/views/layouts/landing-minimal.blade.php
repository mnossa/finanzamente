...
<body class="antialiased bg-white text-surface-900" data-umami-id="{{ env('UMAMI_ID') }}">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                <a href="{{ url('/') }}" class="flex items-center space-x-2" aria-label="Finanzamente — torna alla home">
                    ...
                    <span class="text-lg sm:text-xl font-bold bg-linear-to-r from-primary-700 to-primary-900 bg-clip-text text-transparent">Finanzamente</span>
                </a>
    ...
    >
        <p class="text-sm text-surface-700">
            Con il tuo consenso usiamo statistiche anonime per migliorare le pagine pubbliche di Finanzamente.
        </p>
