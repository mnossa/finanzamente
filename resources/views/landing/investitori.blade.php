...
@section('content')
            ...
            <div class="max-w-2xl mx-auto text-center">
                ...
                @if (Route::has('plan.select'))
                    <a href="{{ route('plan.select') }}?plan=pro&billing_cycle=monthly"
                       ...
                       data-umami-event="landing-cta-investitori"
                       data-umami-event-position="hero">
                        Abbonati a Pro — traccia il tuo portafoglio
    ...
    <section class="py-14 sm:py-20 bg-gradient-to-r from-blue-600 to-primary-700 text-white text-center">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
            ...
            @if (Route::has('plan.select'))
                <a href="{{ route('plan.select') }}?plan=pro&billing_cycle=monthly"
                   class="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-primary-700 bg-white hover:bg-blue-50 rounded-xl shadow-lg transition-all duration-200"
                   data-umami-event="landing-cta-investitori"
                   data-umami-event-position="footer">
                    Attiva Pro — traccia il tuo portafoglio
                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                </a>
