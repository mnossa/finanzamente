...
@section('content')
        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div class="max-w-2xl mx-auto text-center">
                ...
                @include('partials.landing.pro-cta-button', [
                    'label'         => 'Abbonati a Pro — gestisci le finanze di famiglia',
                    'umamiEvent'    => 'landing-cta-famiglie',
                    'umamiPosition' => 'hero',
    ...
    <section class="py-14 sm:py-20 bg-gradient-to-r from-pink-600 to-rose-600 text-white text-center">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-2xl">
            ...
            @include('partials.landing.pro-cta-button', [
                'label'         => 'Attiva Pro — gestisci le finanze di famiglia',
                'umamiEvent'    => 'landing-cta-famiglie',
                'umamiPosition' => 'footer',
                'classes'       => 'inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-pink-700 bg-white hover:bg-pink-50 rounded-xl shadow-lg transition-all duration-200',
            ])
        </div>
    </section>
@endsection
