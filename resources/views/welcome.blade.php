                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm sm:text-base text-surface-700">Grafico della composizione del portafoglio per asset class (azionario, obbligazionario, crypto, liquidità…)</p>
                        </div>
                        <div class="flex items-start gap-3">
                            <div class="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5">
                                <svg class="w-4 h-4 text-blue-700" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm sm:text-base text-surface-700">Supporto per ETF, azioni, indici, materie prime, crypto e altro ancora</p>
                        </div>
                    </div>
                </div>
