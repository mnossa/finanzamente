        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <p class="text-base sm:text-lg md:text-xl text-surface-600 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
                    Finanzamente è un’app di finanza personale open source (MIT) per chi vive in Italia. La installi sul tuo ambiente Docker: movimenti, budget, patrimonio, investimenti e detrazioni, senza piani a pagamento.
                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-surface-50 rounded-2xl p-6 sm:p-8 border border-surface-200">
                    ...
                    <ul class="space-y-2.5 text-sm sm:text-base text-surface-700">
                        ...
                        <li class="flex items-start gap-2">
                            <span class="text-accent-600 font-bold mt-0.5" aria-hidden="true">✓</span>
                            <span>ETF, azioni, obbligazioni, crypto e piani di accumulo</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="text-accent-600 font-bold mt-0.5" aria-hidden="true">✓</span>
                            <span>Asset allocation con indice di rischio da 1 a 7</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <span class="text-accent-600 font-bold mt-0.5" aria-hidden="true">✓</span>
                ...
                <div class="bg-surface-50 rounded-2xl p-6 sm:p-8 border border-surface-200">
                    ...
                    <ul class="space-y-2.5 text-sm sm:text-base text-surface-700">
                        ...
                        <li class="flex items-start gap-2">
                            <span class="text-accent-600 font-bold mt-0.5" aria-hidden="true">✓</span>
                            <span>I movimenti che segni come privati restano solo tuoi. Puoi invitare altri membri al nucleo.</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
                <div>
                    ...
                    <p class="mt-6 text-sm text-surface-500">
                        Se non investi, puoi lasciare spenta la sezione investimenti.
                    </p>
                </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                <h2 id="final-cta-title" class="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
                    Installa e parti dal prossimo movimento
                </h2>
                <p class="text-base sm:text-lg text-primary-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
                    Codice su GitHub, licenza MIT. Clona il repo, copia <code class="text-primary-50">.env.example</code>, avvia con <code class="text-primary-50">make up</code>.
                </p>
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                    <a href="https://github.com/mnossa/finanzamente" class="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-primary-700 bg-white hover:bg-surface-50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200" rel="noopener noreferrer" target="_blank">
                        Vai al repository
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="w-full sm:w-auto inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-medium text-white border-2 border-white/40 hover:bg-white/10 rounded-xl transition-colors">
