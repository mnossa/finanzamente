...
export default function BalancePrivacyToggle() {
    const { hideBalances, toggleHideBalances } = useBalancePrivacy();
    ...
    return (
        <button
            ...
            aria-label={hideBalances ? 'Mostra saldi' : 'Nascondi saldi'}
            aria-pressed={hideBalances}
            title={hideBalances ? 'Mostra saldi' : 'Nascondi saldi'}
        >
            {hideBalances ? (
