...
export default function GuidedFormWizard({
    ...
    return (
        <div className={clsx('mx-auto flex w-full max-w-lg flex-col', className)}>
            ...
            <div className="flex min-h-[min(70vh,32rem)] flex-col justify-center rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-8">
