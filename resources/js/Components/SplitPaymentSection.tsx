        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            {enabled && (
                <div className="space-y-3 border-t border-gray-200 px-4 py-3 dark:border-gray-700">
                    ...
                    <p className={clsx('text-sm', Math.abs(splitSum - (parseFloat(totalAmount) || 0)) > 0.02 ? 'text-amber-600' : 'text-gray-500')}>
                        Totale righe: {formatCurrency(splitSum)} / {formatCurrency(parseFloat(totalAmount) || 0)}
                    </p>
