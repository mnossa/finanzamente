...
export type HubTabIconId = keyof typeof HubTabIcons;

export function renderHubTabIcon(iconId: HubTabIconId | undefined): ReactNode {
    if (!iconId) {
        return null;
    }

    const Icon = HubTabIcons[iconId];
