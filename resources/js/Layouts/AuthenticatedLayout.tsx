...
function SidebarNavItem({
    ...
    const href = item.hrefParams ? route(item.href, item.hrefParams) : route(item.href);
...
export default function Authenticated({
    ...
    const { auth, activeHousehold, notifications: sharedNotifications, isAdmin } = usePage<PageProps>().props;
    ...
    // Le voci bloccate da impostazioni profilo vengono nascoste.
