...
class UpdateInvestmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sell_date' => ['nullable', 'date', 'after_or_equal:buy_date'],
    ...
    public function messages(): array
    {
        return [
            ...
            'sell_price.min' => 'Il prezzo di vendita non può essere negativo.',
            'sell_date.after_or_equal' => 'La data di vendita non può essere precedente alla data di acquisto.',
