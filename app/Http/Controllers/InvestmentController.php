...
class InvestmentController extends Controller
{
    ...
    public function show(Investment $investment): Response
    {
        ...
        // Market price APIs removed; unrealized P/L uses manual sell price when present.
        $currentPrice = null;
    ...
    {
        return 'Profitti non realizzati su prezzi di mercato inseriti o aggiornati a mano. Possono differire dal broker per NAV, orari e commissioni. Patrimonio e saldo conti usano il costo di carico (inclusive commissioni).';
    }
