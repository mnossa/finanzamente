...
Reference material moved out of always-on Cursor rules to save context tokens. Rules live in `.cursor/rules/*.mdc`; this folder is loaded when needed.
...
Legacy entry point: [`.cursorrules`](../../.cursorrules) (short index only).
