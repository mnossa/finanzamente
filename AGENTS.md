...
- **`app_e2e` E2E overrides:** `BREVO_ENABLED=false`, `FEATURE_GUIDED_CREATE_FORMS=false` (form classici per Playwright). Dopo modifiche env E2E: `make e2e-seed` per rigenerare `config_e2e.php`.
